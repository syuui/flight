...
if (isset ($flyTo)) {
	...
	if ($this->Form->isFieldError('Flight.departure_terminal_id')) {
		$popMsg .= $this->Form->error('Flight.departure_terminal_id') . $this->Tag->br();
	}
	if ($this->Form->isFieldError('Flight.departure_terminal_gate')) {
		$popMsg .= $this->Form->error('Flight.departure_terminal_gate') . $this->Tag->br();
	}
	if ($this->Form->isFieldError('Flight.arrival_terminal_id')) {
		$popMsg .= $this->Form->error('Flight.arrival_terminal_id') . $this->Tag->br();
	}
